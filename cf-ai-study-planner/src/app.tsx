...
import { Button, Badge, InputArea, Empty, Surface, Text, Switch } from "@cloudflare/kumo";
...
function Chat() {
  ...
  const starterPrompts = [
    "I have a DBMS exam in 5 days, 6 lectures left, and one assignment. Make me a realistic plan.",
    "Make Wednesday lighter and add 45 minutes of LeetCode daily.",
    "Help me split 3 assignments across this week.",
    "Remind me tomorrow at 9 AM to revise DBMS.",
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-lg font-semibold text-kumo-default leading-tight">
                ...
                Edge-native AI Study Coach with Stateful Planning &amp; Task Scheduling
              </h1>
            ...
            <p className="text-sm text-kumo-subtle">
              ⚡ Stateful AI — your plan evolves with you
            </p>
          </div>
                      ...
                      <div className="pt-2 border-t border-kumo-line">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-kumo-subtle">
                            {mcpToolCount} tool{mcpToolCount !== 1 ? "s" : ""} available from
                            MCP servers
                          </span>
                        </div>
                      </div>
        ...
        <div className="max-w-4xl mx-auto px-5 py-6 space-y-5">
          {messages.length === 0 && (
            <Empty
              ...
              title="Plan, refine, and track your study week"
              contents={
                <div className="flex flex-col items-center gap-3">
                  <Text size="sm" variant="secondary">
                    Create a study plan, revise it over time, retrieve your latest saved
                    plan, and schedule reminders.
                  </Text>
